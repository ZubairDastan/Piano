...
public class AudioSoundPlayer {
    ...
    public static final int MAX_VOLUME = 200, CURRENT_VOLUME = 90;
    ...
    static {
        ...
        // black keys sounds
        SOUND_MAP.put(15, "second_si");
        SOUND_MAP.put(16, "second_la");
        SOUND_MAP.put(17, "second_sol");
        SOUND_MAP.put(18, "second_fa");
        SOUND_MAP.put(19, "second_mi");
        SOUND_MAP.put(20, "second_re");
        SOUND_MAP.put(21, "second_do");
        SOUND_MAP.put(22, "note_si");
        SOUND_MAP.put(23, "note_la");
        SOUND_MAP.put(24, "note_sol");
    }
